 ...
 *
 * Keep in sync with web/src/api/information-sharing-agreement-options.ts and with the
 * checkbox placeholders in
 * api/src/templates/information-sharing-agreements/confidentiality-acknowledgement-template.docx
 *
 * See TK-44.
 */
